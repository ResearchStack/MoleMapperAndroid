...
public class UserSessionInfo
{
     ...
     * specific governance qualifications to access the study's data set.</li> </ul>
     */
     ...
     * for) every consent that is required. Participants do not need to consent to optional consents
     * and their consents do not need to be up-to-date in order to be considered consented for the
     * purpose of communicating with the Bridge server.
     */
     ...
     * server before releasing an application in production</li> <li><b>production</b> the
     * production servers</li> </ul>
     */
     ...
     * these users is documented separately.</li> <li><b>researcher</b> Researchers have rights to
     * access study consents (to add, edit and delete them, as well as publish them), and they have
     * the right to view study participant information. Users with the researcher role will be
     * granted developer privileges as well .</li> <li><b>developer</b> Developers have the right to
     * edit studies, upload schemas, surveys, and schedules. They have complete control over a
     * study's configuration, but they do not have access to the consents or to information about
     * participants in a study. Researchers will be given developer privileges as well as the
     * researcher role.</li> <li><b>consented users</b> Any participant in a study who has consented
     * to research.</li> <li><b>all users</b> A publicly-accessible endpoint. No role required.</li>
     * </ul>
     */
